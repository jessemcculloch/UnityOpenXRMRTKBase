...
namespace Microsoft.MixedReality.OpenXR
{
    ...
    internal class NativeLib
    {
        ...
        internal static extern bool TryGetHandMesh(NativeLibToken token, Handedness handedness, FrameTime frameTime,
            HandPoseType handPoseType, out int vertexCount, Vector3[] vertexPositions, Vector3[] vertexNormals, out int indexCount, int[] indices);
