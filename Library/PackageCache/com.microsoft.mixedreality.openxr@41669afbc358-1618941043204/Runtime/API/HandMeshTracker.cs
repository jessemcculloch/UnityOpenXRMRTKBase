    ...
    public class HandMeshTracker
    {
        ...
        public bool TryGetHandMesh(OpenXR.FrameTime frameTime, Mesh handMesh, HandPoseType handPoseType = HandPoseType.Tracked)
        {
            ...
            try
            {
                ...
                if (NativeLib.TryGetHandMesh(m_token, m_handedness, frameTime, handPoseType, out int vertexCount, m_handMeshVertices, m_handMeshNormals, out int indexCount, m_handMeshIndices))
                {
