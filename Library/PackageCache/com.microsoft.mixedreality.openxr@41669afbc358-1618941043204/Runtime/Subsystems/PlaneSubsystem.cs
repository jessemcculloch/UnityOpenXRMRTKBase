...
{
    internal enum XrSceneObjectKindMSFT {
        XR_SCENE_OBJECT_KIND_UNCATEGORIZED_MSFT = -1,
        XR_SCENE_OBJECT_KIND_BACKGROUND_MSFT = 1,
        XR_SCENE_OBJECT_KIND_WALL_MSFT = 2,
        XR_SCENE_OBJECT_KIND_FLOOR_MSFT = 3,
        XR_SCENE_OBJECT_KIND_CEILING_MSFT = 4,
        XR_SCENE_OBJECT_KIND_PLATFORM_MSFT = 5,
        XR_SCENE_OBJECT_KIND_INFERRED_MSFT = 6,
        XR_SCENE_OBJECT_KIND_WORLD_MSFT = 7,
        XR_SCENE_OBJECT_KIND_MAX_ENUM_MSFT = 0x7FFFFFFF
    }
    ...
    internal struct NativePlane
    {
        ...
        public Vector2 size;
        public XrSceneObjectKindMSFT kind;
    }
    ...
    internal class PlaneSubsystem : XRPlaneSubsystem
    {
        ...
        private class OpenXRProvider : Provider
        {
            ...
            private PlaneClassification ToPlaneClassification(XrSceneObjectKindMSFT kind)
            {
                switch(kind)
                {
                    case XrSceneObjectKindMSFT.XR_SCENE_OBJECT_KIND_WALL_MSFT:
                        return PlaneClassification.Wall;

                    case XrSceneObjectKindMSFT.XR_SCENE_OBJECT_KIND_FLOOR_MSFT:
                        return PlaneClassification.Floor;

                    case XrSceneObjectKindMSFT.XR_SCENE_OBJECT_KIND_CEILING_MSFT:
                        return PlaneClassification.Ceiling;

                    case XrSceneObjectKindMSFT.XR_SCENE_OBJECT_KIND_PLATFORM_MSFT:
                        return PlaneClassification.Table;

                    case XrSceneObjectKindMSFT.XR_SCENE_OBJECT_KIND_UNCATEGORIZED_MSFT:
                    case XrSceneObjectKindMSFT.XR_SCENE_OBJECT_KIND_BACKGROUND_MSFT:
                    case XrSceneObjectKindMSFT.XR_SCENE_OBJECT_KIND_INFERRED_MSFT:
                    case XrSceneObjectKindMSFT.XR_SCENE_OBJECT_KIND_WORLD_MSFT:
                    case XrSceneObjectKindMSFT.XR_SCENE_OBJECT_KIND_MAX_ENUM_MSFT:
                    default:
            ...
            private BoundedPlane ToBoundedPlane(NativePlane nativePlane, BoundedPlane defaultPlane)
            {
                return new BoundedPlane(
                    ...
                    ToPlaneClassification(nativePlane.kind)); // TODO: Replace the nativePtr
            }
        }
